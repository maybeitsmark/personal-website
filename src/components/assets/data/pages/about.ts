...
export const homePageContent ={
  ...
  interests: `software / art / fabrication`,
  about:`As a creative developer, I merge my interests in programming, design, and art. 
  My approach is holistic, covering user experience from research and design to engineering. 
  I enjoy creating interactive experiences that encourage a personal connection with users.`
}
